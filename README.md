...
2. Run cmake and make commands, as described in Step 3 of [Installation Instructions](https://openfhe-development.readthedocs.io/en/latest/sphinx_rsts/intro/installation/installation.html).

3. You can then run the below examples by entering
